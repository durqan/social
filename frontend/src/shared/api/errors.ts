...
const uploadErrorText: Record<string, string> = {
    ...
    'avatar is too large': 'Аватар слишком большой. Максимум 10 МБ.',
    ...
    'message attachments are too large': 'Общий размер вложений не должен превышать 500 МБ.',
    'too many attachments': 'Можно прикрепить максимум 5 файлов за раз.',
    'video is too large': 'Видео слишком большое. Максимум 500 МБ.',
    'audio is too large': 'Аудио слишком большое. Максимум 100 МБ.',
    'file is too large': 'Файл слишком большой. Максимум 100 МБ.',
    ...
    'voice is too large': 'Голосовое сообщение слишком большое. Максимум 100 МБ.',
    'voice must be webm, ogg or m4a': 'Голосовое сообщение должно быть в формате WebM, Ogg или M4A.',
    ...
    'video note is too large': 'Кружок слишком большой. Максимум 100 МБ.',
    ...
    'video note is too long': 'Кружок слишком длинный. Максимум 5 минут.',
};
